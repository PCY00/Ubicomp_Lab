...
| 구동부 센서             | <br>수직 초기화 리미트 스위치 3개<br>수평 초기화 스위치 1개<br>쿨러 제어 토글 스위치 1개<br>온오프 스위치 2개<br>스테핑 모터 NEMA17 6개 (토크: 4.0 3개, 6.5 3개)     |    |                            |
| 기타                 | <br>프로파일 30 x 30 20개<br>프로파일 20 x 20 4개<br>베어링 6개<br>작은 베어링 1개 (수평 초기화 보조)<br>원형 봉 1개<br>외주 아크릴판 6개<br>파워서플라이 2개 (LRS-350-24)<br>3D 프린터로 나머지 재료 제작 (PLA+ 재질)                                                                                                            |    |                            |
